...
--save-model=./output/model_20.pt --num-train-pts=690000 --num-val-pts=300000 --points-per-user=10 --mini-batch-size=256 \
--nepochs=1 --numpy-rand-seed=123 --arch-embedding-size="987994-4162024-9439" --print-freq=100 --test-freq=2000 --num-batches=0  \
--raw-train-file=/home/ubuntu/datasets/taobao/taobao_train.txt --raw-test-file=/home/ubuntu/datasets/taobao/taobao_test.txt --pro-train-file=./output/taobao_train_t20.npz \
